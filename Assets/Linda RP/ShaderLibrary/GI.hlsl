...
#include "Packages/com.unity.render-pipelines.core/ShaderLibrary/ImageBasedLighting.hlsl" //计算Cubemap mip
...
{
#if defined(LIGHTMAP_ON)
	//float4 transform 是UV的缩放和平移，在11行代码里做了，这里不管
	//bool encodedLightmap 是否有压缩
	//real4 decodeInstructions 解码指令
